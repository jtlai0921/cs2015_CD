<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm11.aspx.cs" Inherits="FirstJQM.WebForm11" %>
      ...
      <div data-role="footer" data-position="fixed" >
        <div data-role="navbar" >
          <ul>
            ...
            <li><a href="#" data-icon="check">書籍</a></li>
            <li><a href="#" data-icon="forward">關於我們</a></li>
          </ul>
        </div>
