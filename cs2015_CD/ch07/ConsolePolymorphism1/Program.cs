...
{
    class Employee  // 定義Employee員工類別當父類別
    {
    ...
    class Manager : Employee  // Manager經理類別繼承自Employee員工類別
    {
        ...
        public override int Salary  //子類別的屬性
        {
            get
            {
        ...
        public void ShowTotal()   // 子類別方法
        {
            Console.WriteLine("\n 實領的薪資：{0}元", (Bonus + Salary).
                               ToString("0,0"));
        }
    }
    class Program
    {
        static void Main(string[] args)
        {
            ...
            peter.Salary = 70000;
            Console.WriteLine("\n Peter 經理的薪資 : {0}元",
                 peter.Salary.ToString("0,0"));
            peter.Bonus = 30000;
            Console.WriteLine("\n Peter 經理的獎金 : {0}元",
                 peter.Bonus.ToString("0,0"));
            peter.ShowTotal();
            Console.Read();
        }
    }
