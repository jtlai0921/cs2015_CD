...
namespace ConsoleFormat
{
    class Program
    {
        static void Main(string[] args)
        {
                   ...
                   num3 = 1234.567;
                   num4 = -1234.567;
                   Console.WriteLine("num3=1234.567      num4=-1234.567 的 C/c3 格式分別為:");
                   ...
                   Console.WriteLine("num1=123456   num2=-123456 的 D9/d3/D 格式分別為 :");
                   Console.WriteLine("num1={0:D9}  num2={1:d3}  num2={2:D}", num1, num2, num2);            
                   Console.WriteLine();

                   Console.WriteLine("num3=1234.567       num4=-1234.567 的 E/e2 格式分別為 :");
                   ...
                   num3 = 1234.567;
                   num4 = -1234.567;
                   Console.WriteLine("num3=1234.567  num4=-1234.567 的 G3 和 g 格式分別為 :");
                   Console.WriteLine("num3={0:G3}   num4={1:g} ", num3, num4);
                   Console.WriteLine();

                   num3 = 1234.567;
                   num4 = -1234.567;
                   Console.WriteLine("num3=1234.567 num4=-1234.567 的G/g4 格式分別為:");
                   Console.WriteLine("num3={0:G}   num4={1:g4} ", num3, num4);
                   Console.WriteLine();
            
                    num3 = 1234.567;
                    num4 = -1234.567;
                    Console.WriteLine("num3=1234.567   num4=-1234.567 的 N3 和 n 格式分別為 :");
